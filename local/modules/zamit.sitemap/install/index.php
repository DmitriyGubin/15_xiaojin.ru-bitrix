...
class zamit_sitemap extends CModule
{
    ...
    public function InstallFiles($arParams = array())
    {
        if ($_ENV["COMPUTERNAME"]!='BX') {
            CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/local/modules/zamit.sitemap/install/admin/", $_SERVER["DOCUMENT_ROOT"]."/bitrix/admin");
            CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/local/modules/zamit.sitemap/install/images/", $_SERVER["DOCUMENT_ROOT"]."/bitrix/images/zamit.sitemap", true, true);
        }
    ...
    {
        if ($_ENV["COMPUTERNAME"]!='BX') {
            DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/local/modules/zamit.sitemap/install/admin/", $_SERVER["DOCUMENT_ROOT"]."/bitrix/admin");
    ...
    public function DoInstall()
    {
        ...
        $step = IntVal($step);
        if ($step < 2) {
            $APPLICATION->IncludeAdminFile(GetMessage("SITEMAP_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/local/modules/zamit.sitemap/install/step1.php");
        } elseif ($step == 2) {
            ...
            $APPLICATION->IncludeAdminFile(GetMessage("SITEMAP_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/local/modules/zamit.sitemap/install/step2.php");
        }
    }
    ...
    public function DoUninstall()
    {
        ...
        $step = IntVal($step);
        if ($step < 2) {
            $APPLICATION->IncludeAdminFile(GetMessage("SITEMAP_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/local/modules/zamit.sitemap/install/unstep1.php");
        } elseif ($step == 2) {
            ...
            $this->UnInstallFiles();
            $GLOBALS["errors"] = $this->errors;
            $APPLICATION->IncludeAdminFile(GetMessage("SITEMAP_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/local/modules/zamit.sitemap/install/unstep2.php");
        }
    }
